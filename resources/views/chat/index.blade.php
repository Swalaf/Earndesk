...
<div class="py-6">
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div class="mb-8">
            ...
            <p class="mt-1 text-sm text-gray-500">View and manage your conversations</p>
        </div>
        ...
        <div class="grid grid-cols-1 lg:grid-cols-3 gap-6">
                ...
                <div class="divide-y divide-gray-100 max-h-[600px] overflow-y-auto">
                    @forelse($conversations as $conversation)
                        ...
                        <a href="{{ route('chat.show', $conversation) }}" 
                           class="block p-4 hover:bg-gray-50 transition-colors {{ $unreadCount > 0 ? 'bg-blue-50' : '' }}">
                    ...
                    @empty
                        <div class="p-8 text-center">
                            ...
                            <p class="text-xs text-gray-400 mt-1">Start a conversation by purchasing a service or posting a task</p>
                        </div>
                    @endforelse
                </div>
            ...
            <!-- Empty State -->
            <div class="lg:col-span-2 bg-white rounded-xl shadow-sm border border-gray-100 flex items-center justify-center min-h-[400px]">
