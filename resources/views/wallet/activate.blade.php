...
@section('title', 'Activate Account - EarnDesk')
        ...
        @else
            ...
            <div class="bg-white dark:bg-dark-900 rounded-2xl shadow-xl shadow-gray-200/50 dark:shadow-dark-950/50 border border-gray-100 dark:border-dark-700 overflow-hidden">
                ...
                <div class="bg-gradient-to-r from-indigo-600 to-purple-600 p-8 text-white text-center">
                    ...
                    <h1 class="text-2xl md:text-3xl font-bold">Activate Your Account</h1>
                    <p class="mt-2 opacity-90">Unlock full access to all features</p>
                </div>
                ...
                <div class="px-8 pt-6">
                    <div class="bg-gray-50 dark:bg-dark-800 rounded-xl p-4">
                        <div class="flex justify-between items-center">
                            <span class="text-gray-600 dark:text-gray-400">Your Current Balance</span>
                ...
                <!-- Benefits -->
                <div class="p-8">
                    <h2 class="font-bold text-gray-900 dark:text-gray-100 mb-4 text-lg">What you get after activation:</h2>
                    <ul class="space-y-4 mb-8">
                        <li class="flex items-start">
                            <div class="w-8 h-8 rounded-full bg-green-100 dark:bg-green-500/20 flex items-center justify-center mr-3 mt-0.5">
                                <i class="fas fa-check-circle text-green-600 dark:text-green-400 text-sm"></i>
                            </div>
                            <span class="text-gray-600 dark:text-gray-400">Create unlimited tasks to grow your social media</span>
                        </li>
                        <li class="flex items-start">
                            <div class="w-8 h-8 rounded-full bg-green-100 dark:bg-green-500/20 flex items-center justify-center mr-3 mt-0.5">
                                <i class="fas fa-check-circle text-green-600 dark:text-green-400 text-sm"></i>
                            </div>
                            <span class="text-gray-600 dark:text-gray-400">Complete tasks and earn real money</span>
                        </li>
                        <li class="flex items-start">
                            <div class="w-8 h-8 rounded-full bg-green-100 dark:bg-green-500/20 flex items-center justify-center mr-3 mt-0.5">
                                <i class="fas fa-check-circle text-green-600 dark:text-green-400 text-sm"></i>
                            </div>
                            <span class="text-gray-600 dark:text-gray-400">Withdraw earnings to your bank account</span>
                        </li>
                        <li class="flex items-start">
                            <div class="w-8 h-8 rounded-full bg-green-100 dark:bg-green-500/20 flex items-center justify-center mr-3 mt-0.5">
                                <i class="fas fa-check-circle text-green-600 dark:text-green-400 text-sm"></i>
                            </div>
                            <span class="text-gray-600 dark:text-gray-400">Level up and unlock premium tasks</span>
                        </li>
                    </ul>

                    <!-- Earning Opportunities Preview -->
                    <div class="bg-gradient-to-br from-green-50 to-emerald-50 dark:from-green-500/10 dark:to-emerald-500/10 rounded-2xl p-6 mb-8 border border-green-200 dark:border-green-500/30">
                        <div class="flex items-center mb-4">
                            <div class="w-10 h-10 rounded-full bg-green-100 dark:bg-green-500/20 flex items-center justify-center mr-3">
                                <i class="fas fa-money-bill-wave text-green-600 dark:text-green-400"></i>
                            </div>
                            <div>
                                <h3 class="font-bold text-gray-900 dark:text-gray-100">Earning Opportunities Await!</h3>
                                <p class="text-sm text-gray-600 dark:text-gray-400">You can earn from tasks like these after activation</p>
                            </div>
                        </div>
                        <div class="grid grid-cols-2 gap-3">
                            <div class="bg-white dark:bg-dark-800 rounded-xl p-4 border border-green-100 dark:border-green-500/20">
                                <div class="text-2xl font-bold text-green-600 dark:text-green-400">₦2,500</div>
                                <p class="text-xs text-gray-500 dark:text-gray-400">Micro Tasks</p>
                            </div>
                            <div class="bg-white dark:bg-dark-800 rounded-xl p-4 border border-green-100 dark:border-green-500/20">
                                <div class="text-2xl font-bold text-purple-600 dark:text-purple-400">₦5,000</div>
                                <p class="text-xs text-gray-500 dark:text-gray-400">UGC Content</p>
                            </div>
                            <div class="bg-white dark:bg-dark-800 rounded-xl p-4 border border-green-100 dark:border-green-500/20">
                                <div class="text-2xl font-bold text-blue-600 dark:text-blue-400">₦3,000</div>
                                <p class="text-xs text-gray-500 dark:text-gray-400">Growth Tasks</p>
                            </div>
                            <div class="bg-white dark:bg-dark-800 rounded-xl p-4 border border-green-100 dark:border-green-500/20">
                                <div class="text-2xl font-bold text-yellow-600 dark:text-yellow-400">₦7,500</div>
                    ...
                    <div class="bg-gray-50 dark:bg-dark-800 rounded-xl p-4 mb-8">
                        <div class="flex items-center justify-between mb-3">
                            <h4 class="font-semibold text-gray-900 dark:text-gray-100">Recent Earnings</h4>
                        ...
                        <div class="space-y-2 text-sm">
                            <div class="flex justify-between items-center py-2 border-b border-gray-100 dark:border-dark-700">
                                <span class="text-gray-600 dark:text-gray-400">User***4832</span>
                                <span class="font-semibold text-green-600 dark:text-green-400">+₦1,500</span>
                                <span class="text-gray-400 text-xs">2 min ago</span>
                            </div>
                            <div class="flex justify-between items-center py-2 border-b border-gray-100 dark:border-dark-700">
                                <span class="text-gray-600 dark:text-gray-400">User***7291</span>
                                <span class="font-semibold text-green-600 dark:text-green-400">+₦2,800</span>
                                <span class="text-gray-400 text-xs">15 min ago</span>
                            </div>
                            <div class="flex justify-between items-center py-2">
                                <span class="text-gray-600 dark:text-gray-400">User***1056</span>
                                <span class="font-semibold text-green-600 dark:text-green-400">+₦750</span>
                    ...
                    <!-- Pricing -->
                    <div class="bg-gradient-to-br from-indigo-50 to-purple-50 dark:from-indigo-500/10 dark:to-purple-500/10 rounded-2xl p-6 mb-8">
                        <div class="flex items-center justify-between mb-4">
                            <span class="text-gray-600 dark:text-gray-400">Activation Fee</span>
                    ...
                    <div class="bg-yellow-50 dark:bg-yellow-500/10 border border-yellow-200 dark:border-yellow-500/20 rounded-xl p-4 mb-6">
                        ...
                        <a href="{{ route('wallet.deposit') }}" class="mt-3 inline-flex items-center px-4 py-2 bg-yellow-500 hover:bg-yellow-600 text-white rounded-lg font-medium transition-colors">
                    ...
                    @else
                    <button type="button" onclick="alert('Please deposit funds first')" class="w-full py-4 bg-gray-300 dark:bg-dark-700 text-gray-500 dark:text-gray-400 font-bold rounded-xl cursor-not-allowed">
